/* NetId(s): eb654, wjw97 Time spent: 4 hours, 30 minutes.
 * Name(s): Eldor Bekpulatov, Billy Wilkinson
 */
...
class PaintGUI extends JFrame implements ActionListener, ChangeListener {
	...
	public void stateChanged(ChangeEvent e) {
		...
		if (s == toolSizeSlider) {
			...
			canvas.setToolSize(((JSlider) s).getValue());
	...
	private void updateSizeLabel() {
		...
		sizeLabel.setText("Image: " + canvas.getImg().getWidth() +
				" x " + canvas.getImg().getHeight());
